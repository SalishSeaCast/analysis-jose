...
def turb_mix(particle,fieldset,time):
    ...
    if particle.beached==0:
        #Vertical mixing
        if particle.depth + 0.5/factor > bath: #Only calculate gradient of diffusion for particles deeper than 0.5 otherwise OP will check for particles outside the domain and remove it.
